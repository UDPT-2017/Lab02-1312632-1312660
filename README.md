...
* [x] Cho phép người dùng biết họ đang ở trang nào (sử dụng breadcrumb, highlight navigation bar,...). (**1312632**)
* [x] Cho phép người dùng đăng ký tài khoản bằng các thông tin: email, password, name, phone.(**1312660**)
...
* [x] Trang about thể hiện thông tin nhóm thực hiện đề tài.(**1312632**)
